...
switch(calib.warptype)
    case {'HalfCylinderProjection', 'SphereProjection', 'CurvatureCorrection'}
        ...
        elseif strcmpi(calib.warptype, 'CurvatureCorrection')
            % Use curvature correction shader:
            warpstruct.glsl = LoadGLSLProgramFromFiles('CurvatureCorrectionShader');
        else
        ...
        if strcmpi(calib.warptype, 'CurvatureCorrection')
            % Additional parameters for curvature correction:
            glUniform1f(glGetUniformLocation(warpstruct.glsl, 'ScrDist'), calib.ScrDist);
            glUniform2f(glGetUniformLocation(warpstruct.glsl, 'ScrSz'), calib.ScrSz(1), calib.ScrSz(2));
        end        
