function [gratingid, gratingrect] = CreateProceduralGratingMod2(windowPtr, type, width, height, backgroundColorOffset, radius, contrastPreMultiplicator)
...
%     gratingShader = LoadGLSLProgramFromFiles('BasicSineGratingShader', 1);
    gratingShader = LoadGLSLProgramFromFiles([path filesep 'GSGLShaders' filesep 'modBasicSineGratingShader'], 1);
elseif strcmp('square', type)
    gratingShader = LoadGLSLProgramFromFiles([path filesep 'GSGLShaders' filesep 'modBasicSquareGratingShader'], 1);
end
