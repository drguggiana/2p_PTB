...
function [stimtype, vbl] = PresentLooming( nidaq, screen, vbl, Param, stimtype, tar_eye )
    ...
    % Set screen alpha blending parameters bsed on the stimulus
    if stimtype.useChecker == 0
        % Disable alpha blending
    	Screen('BlendFunction', win, GL_ONE, GL_ZERO);
    else
    	% Enable alpha blending for combination of the aperture with the checkerboard stimulus:
